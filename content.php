	...
	<div id="single_wrapper">
		...
		<script>
			$(function(){
				...
				if(part !='') {
					$('#single_wrapper > div > .wpshop_bag .wpshop_buy td.wpshop_button').html('<a href="'+part+'" target="_blank"><span><?php _e( '_', 'wp-shop' ); ?></span></a>');
				}
		...
		<?php if($similar_products == 1) {?>
			...
			<h2 class="page_title similar_text"><?php _e( 'Подходящие товары:', 'wp-shop' ); ?></h2>
		<?php 	$tag_ids = '';
			$arg ['orderby'] = 'rand';
			$arg ['order'] = 'DESC';
